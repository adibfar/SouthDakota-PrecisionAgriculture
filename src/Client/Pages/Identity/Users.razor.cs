...
namespace PAS.Client.Pages.Identity
{
    public partial class Users
    {
        ...
        private async Task ExportToExcel()
        {
            ...
            _snackBar.Add(string.IsNullOrWhiteSpace(_searchString)
                ? "Users exported" : "Filtered Users exported", Severity.Success);
        }
        ...
        {
            if (email == "pouriya.adibfar@gmail.com") _snackBar.Add("Not Allowed.", Severity.Error);
