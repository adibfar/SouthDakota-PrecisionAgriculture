...
{
    public partial class AddEditFarmModal
    {
        [Inject] private IFarmManager FarmManager { get; set; }

        [Parameter] public AddEditFarmCommand AddEditFarmModel { get; set; } = new();
        ...
        {
            var response = await FarmManager.SaveAsync(AddEditFarmModel);
