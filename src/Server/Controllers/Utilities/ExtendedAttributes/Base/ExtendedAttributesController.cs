...
using PAS.Application.Features.ExtendedAttributes.Commands.AddEdit;
using PAS.Application.Features.ExtendedAttributes.Commands.Delete;
using PAS.Application.Features.ExtendedAttributes.Queries.Export;
using PAS.Application.Features.ExtendedAttributes.Queries.GetAll;
using PAS.Application.Features.ExtendedAttributes.Queries.GetAllByEntityId;
using PAS.Application.Features.ExtendedAttributes.Queries.GetById;
using PAS.Domain.Contracts;
using Microsoft.AspNetCore.Mvc;

namespace PAS.Server.Controllers.Utilities.ExtendedAttributes.Base
{
    /// <summary>
