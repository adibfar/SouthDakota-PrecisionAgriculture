...
using PAS.Infrastructure.Extensions;
using PAS.Server.Extensions;
using PAS.Server.Filters;
using PAS.Server.Managers.Preferences;
using PAS.Server.Middlewares;
using System.IO;

namespace PAS.Server
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            {
                DashboardTitle = "Precision Agriculture System Jobs",
